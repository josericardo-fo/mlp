...
class TestActivations(unittest.TestCase):
    ...
    def test_sigmoid(self):
        ...
        np.testing.assert_almost_equal(
            self.activations.sigmoid(input_data), expected_output
        )
    ...
    def test_sigmoid_derivative(self):
        ...
        np.testing.assert_almost_equal(
            self.activations.sigmoid_derivative(input_data), expected_derivative
        )
    ...
    def test_relu(self):
        ...
        np.testing.assert_almost_equal(
            self.activations.relu(input_data), expected_output
        )
    ...
    def test_relu_derivative(self):
        ...
        np.testing.assert_almost_equal(
            self.activations.relu_derivative(input_data), expected_derivative
        )
    ...
    def test_tanh(self):
        ...
        np.testing.assert_almost_equal(
            self.activations.tanh(input_data), expected_output
        )
    ...
    def test_tanh_derivative(self):
        ...
        np.testing.assert_almost_equal(
            self.activations.tanh_derivative(input_data), expected_derivative
        )
